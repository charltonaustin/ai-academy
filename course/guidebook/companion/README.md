...
- NestJS + Sequelize + REST infrastructure
...
[Installable Angular PWA](day-4-mobile-app.md)

**Required:** PWA foundation (service worker + manifest)
...
**Day 4:** Mobile Platform - Angular PWA (service worker + web manifest)
