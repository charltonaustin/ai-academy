...
1. **Initialize:**
   ...
   ```bash
   /orchestration .claude/meta/session-handoffs/[this-file-name].md
   ```
...
**Session Continuation:** Use `/orchestration .claude/meta/session-handoffs/[this-file].md` in new session
